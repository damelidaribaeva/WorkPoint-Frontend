...
const TopCoworkings = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
      <h1 className="text-3xl font-medium">Top Coworkings to Book</h1>
      <p className="sm:w-1/3 text-center text-sm">
        Discover the best coworking spaces tailored for your productivity.
      </p>
      <div
        className="w-full grid gap-4 pt-5 gap-y-6 px-3 sm:px-0"
        style={{ gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))" }}
      >
        {coworkingSpaces.slice(0, 10).map((item, index) => (
          <div
